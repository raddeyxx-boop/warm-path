-- Fix PL/pgSQL ambiguity between the workflow_run_id output variable and child columns.
-- This replaces the already-deployed RPC without deleting any data during migration.
...
begin
  ...
  if exists (
    ...
    where c.table_schema = 'public'
      and c.table_name = 'ranked_candidates'
